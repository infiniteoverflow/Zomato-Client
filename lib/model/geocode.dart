class Location {
  ...
  Location({this.entityType, this.entityId, this.title, 
  this.lat, this.long, this.cityId, this.cityName, 
...
class Popularity {
  ...
  Popularity({this.popularity, this.nightlifeIndex, this.nearbyRes, 
  this.topCuisines, this.popularityRes, this.nightlifeRes, 
  this.subzone, this.subzoneId, this.city});
