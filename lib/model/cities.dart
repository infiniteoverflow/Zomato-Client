class City {
  ...
  this.countryFlagUrl, this.shouldExperimentWith, this.hasGoOutTab, 
  this.discoveryEnabled, this.hasNewAdFormat, this.isState, 
...
class CitiesResponse {
  ...
  CitiesResponse({this.cityList,this.hasMore,this.hasTotal,this.status,this.userHasAddress});
