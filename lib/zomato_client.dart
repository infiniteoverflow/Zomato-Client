...
class Zomato {
  ...
  Future getCityDetails(
      {String q,
      String lat,
      String long,
      String cityIds,
      int count,
      bool asObject = false}) async {
  ...
  Future getCollections(
    ...
    if (jsonData.containsKey('code'))
      ...
      if (asObject == true)
        return Collections.fromList(json.decode(response.body)['collections']);
      else
        return json.decode(response.body);
    }
  }
  ...
  Future getCuisines(
      {String lat, String long, int cityId, bool asObject = false}) async {
    ...
    if (jsonData.containsKey('code'))
      ...
      if (asObject == true)
        return Cuisines.fromList(json.decode(response.body)['cuisines']);
      else
        return json.decode(response.body);
    }
  }
  ...
  Future getEstablishment(
    ...
    if (jsonData.containsKey('code'))
      ...
      if (asObject == true)
        return Establishments.fromList(
            json.decode(response.body)['establishments']);
      else
        return json.decode(response.body);
    }
  }
  ...
  Future getGeocode(
      {@required double lat, @required double long, bool asObject}) async {
    assert(lat != null);
    assert(long != null);
  ...
  Future getLocation(
    ...
    if (jsonData.containsKey('code'))
      ...
      if (asObject == true)
        return loc.Location.fromJson(json.decode(response.body));
      else
        return json.decode(response.body);
    }
  }
  ...
  Future getDailyMenus({@required resId, bool asObject}) async {
    ...
    if (jsonData.containsKey('code'))
      ...
      if (asObject == true)
        return DailyMenuList.fromList(
            json.decode(response.body)['daily_menus']);
      else
        return json.decode(response.body);
    }
  }
